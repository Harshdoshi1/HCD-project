...
const StudentBloomsDistribution = sequelize.define('StudentBloomsDistribution', {
    ...
    bloomsTaxonomyId: {
        type: DataTypes.INTEGER,
        allowNull: false,
        comment: 'Reference to blooms_taxonomy.id (1=Remember, 2=Understand, 3=Apply, 4=Analyze, 5=Evaluate, 6=Create)'
    },
    assignedMarks: {
        type: DataTypes.DECIMAL(5, 2),
        allowNull: false,
        defaultValue: 0.00,
        comment: 'Total weighted marks accumulated for this Bloom\'s taxonomy level from all components'
    }
}, {
    tableName: 'student_blooms_distribution',
    ...
    indexes: [
        {
            unique: true,
            name: 'idx_unique_student_subject_semester_blooms',
