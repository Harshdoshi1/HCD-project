...
import { BookOpen, Users, Award, Calendar, Clock, CheckCircle } from 'lucide-react';
                                ...
                                <div className="dashboard-sections">
                                    <header className="faculty-dashboard-header">
                                        ...
                                        <div className="dashboard-actions">
                                            <button className="btn-primary"><Calendar size={16} style={{marginRight: '6px'}} /> Record Attendance</button>
                                            <button className="btn-secondary"><BookOpen size={16} style={{marginRight: '6px'}} /> Generate Reports</button>
                                        </div>
                                    </header>
                                        ...
                                        <div className="chart-box">
                                            ...
                                            <ResponsiveContainer width="100%" height={250}>
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <Bar dataKey="completion" fill="#3674B5" radius={[4, 4, 0, 0]} />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        </div>
                                            ...
                                            <ResponsiveContainer width="100%" height={250}>
                                                ...
                                                >
                                                    ...
                                                    <Line 
                                                        ...
                                                        strokeWidth={2}
                                                        dot={{ r: 4, strokeWidth: 2, fill: '#fff' }}
                                                        activeDot={{ r: 6, strokeWidth: 0, fill: '#F44336' }}
                                                    />
                                                </LineChart>
                                            </ResponsiveContainer>
                                        </div>
                                        ...
                                        <div className="chart-box recent-activity">
                                            ...
                                            <div className="activity-list">
                                                {recentActivity.map((activity, index) => (
                                                    <div className="activity-item" key={index} style={{animationDelay: `${index * 0.1}s`}}>
                                                        <div className="activity-date">{activity.date}</div>
                                                        <div className="activity-content">
                                                            <div className="activity-title">{activity.activity}</div>
                                                            <div className="activity-count">{activity.count} items</div>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
