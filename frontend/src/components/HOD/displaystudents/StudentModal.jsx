...
//             uploadRowWise(parsedData);
//         };
//         reader.onerror = (error) => console.error("Error reading file:", error);
//     };

//     async function uploadRowWise(parsedData) {
...
//                     <button onClick={() => setIsManualEntry(true)}>Manual Entry</button>
...
//                         <button type="button" onClick={clearFileUpload}>Clear File</button>
//                     </div>
//                 )}
//             </div>
//         </div>
