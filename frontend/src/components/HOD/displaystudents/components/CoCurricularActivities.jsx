...
const CoCurricularActivities = ({
  ...
  const fetchAllActivities = async () => {
    try {
      const response = await fetch('http://localhost:5001/api/students/cocurricular/getco', {
        method: 'POST',
        headers: {
  ...
  const fetchSemesterActivities = async () => {
    try {
      const response = await fetch('http://localhost:5001/api/students/cocurricular/getCoWithSem', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
